...
while completion ~=1
    [nfigs,nadjusted_xyz]= adjustImagev2(p,stat,crshift,figs,ops,id_vect,ypix_zplane,'zstack_drift',zstack_drift,'surround',0,'idx',unc(i),'type','zstack','zstack',zstack,'adjusted_xyz',adjusted_xyz);
